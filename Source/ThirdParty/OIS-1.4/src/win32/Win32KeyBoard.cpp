...
int Win32Keyboard::_translateText( KeyCode kc )
{
	...
	{	// Convert a non-combining diacritical mark into a combining diacritical mark
		...
		switch(buff[0])	{
		case 0x5E: // Circumflex accent: ?			deadKey = 0x302; break;
		case 0x60: // Grave accent: ?			deadKey = 0x300; break;
		case 0xA8: // Diaeresis: ?			deadKey = 0x308; break;
		case 0xB4: // Acute accent: ?			deadKey = 0x301; break;
		case 0xB8: // Cedilla: ?			deadKey = 0x327; break;
		default:
