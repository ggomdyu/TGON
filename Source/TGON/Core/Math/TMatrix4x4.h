...
inline TMatrix4x4 TMatrix4x4::operator+(const TMatrix4x4& rhs) const
{
#if TGON_SUPPORT_SSE
    TMatrix4x4 ret;
...
inline const TMatrix4x4& TMatrix4x4::operator*=(const TMatrix4x4& rhs)
{
    *this = (*this)*rhs;
    return *this;
}
...
inline float* TMatrix4x4::operator[](std::size_t index)
{
    assert((index < 4 || index > -1) && "TMatrix4x4 index out of range");
    return (&_00 + index * 4);
}

inline const float* TMatrix4x4::operator[](std::size_t index) const
{
    assert((index < 4 || index > -1) && "TMatrix4x4 index out of range");
    return (&_00 + index * 4);
}

inline TMatrix4x4 TMatrix4x4::Translate(float x, float y, float z)
{
    return{
        1.f, 0.f, 0.f, 0.f,
        0.f, 1.f, 0.f, 0.f,
...
inline TMatrix4x4 TMatrix4x4::Scale(float x, float y, float z)
{
    return{
        x,   0.f, 0.f, 0.f,
        0.f, y,	  0.f, 0.f,
