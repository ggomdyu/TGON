...
TMatrix4x4::TMatrix4x4(const TMatrix3x3& rhs) :
...
TMatrix4x4 TMatrix4x4::operator-(const TMatrix4x4& rhs) const
{
    return{
...
const TMatrix4x4& TMatrix4x4::operator+=(const TMatrix4x4& rhs)
{
    _00 += rhs._00; _01 += rhs._01; _02 += rhs._02; _03 += rhs._03;
    _10 += rhs._10; _11 += rhs._11; _12 += rhs._12; _13 += rhs._13;
    _20 += rhs._20; _21 += rhs._21; _22 += rhs._22; _23 += rhs._23;
...
TMatrix4x4 TMatrix4x4::PerspectiveFovLH(float fovY, float aspectRatio, float nearZ, float farZ)
{
...
TMatrix4x4 TMatrix4x4::Viewport(float x, float y, float width, float height, float minZ, float maxZ)
{
