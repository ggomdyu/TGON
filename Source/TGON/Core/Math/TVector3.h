...
public:
    ...
    const TVector3 operator-(const TVector3&) const noexcept;
    const TVector3 operator*(const TVector3&) const noexcept;
    friend const TVector3 operator*(float lhs, const TVector3& rhs) noexcept;
    ...
    bool operator==(const TVector3&) const noexcept;
    bool operator!=(const TVector3&) const noexcept;
...
public:
    ...
    static TVector3 Cross(const TVector3& a, const TVector3& b) noexcept;
...
inline const TVector3 TVector3::operator/(float rhs) const
{
    assert(rhs != 0.0f && "Vector elements can't be divided by zero.");
...
inline TVector3& TVector3::operator/=(float rhs)
{
	const float inverse = 1.0f / rhs;
...
inline bool TVector3::operator==(const TVector3& rhs) const noexcept
{
...
inline float TVector3::Dot(const TVector3& a, const TVector3& b) noexcept
{
    return (a.x * b.x) + (a.y * b.y) + (a.z * b.z);
}

inline TVector3 TVector3::Cross(const TVector3& a, const TVector3& b) noexcept
{
...
inline float TVector3::LengthSq() const noexcept
{
	return (x * x) + (y * y) + (z * z);
}
