...
{
    // TODO: Not uniform?
	return detail::AutoCastProxy<FromTy, detail::SafeCast<FromTy>>( std::forward<FromTy>( rhs ));
}

template <typename FromTy>
detail::AutoCastProxy<FromTy, detail::UnsafeCast<FromTy>> force_auto_cast( FromTy&& rhs ) noexcept
{
	return detail::AutoCastProxy<FromTy, detail::UnsafeCast<FromTy>>( std::forward<FromTy>( rhs ));
}
