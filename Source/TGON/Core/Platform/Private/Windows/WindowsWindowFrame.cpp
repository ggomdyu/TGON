...
void WindowsWindowFrame::GetPosition(int32_t* x, int32_t* y) const
{
    RECT rt;
...
void WindowsWindowFrame::GetSize(int32_t* width, int32_t* height) const
{
    RECT rt;
...
void WindowsWindowFrame::GetCaptionText(wchar_t* dest) const
{
...
void WindowsWindowFrame::SetPosition(int32_t x, int32_t y)
{
    ::SetWindowPos(m_wndHandle, nullptr, x, y, 0, 0, SWP_NOSIZE);
}

void WindowsWindowFrame::SetScale(int32_t width, int32_t height)
{
    ::SetWindowPos(m_wndHandle, nullptr, 0, 0, width, height, SWP_NOMOVE);
}

void WindowsWindowFrame::SetCaption(const wchar_t* caption)
{
...
DWORD WindowsWindowFrame::EnableGlobalInputHook(bool isEnable, RawInputType inputFlag)
{
    ...
    if (succeed == FALSE)
    {
        ...
        MessageBoxW(m_wndHandle, L"Failed to invoke ::RegisterRawInputDevices.", L"WARNINIG!", MB_OK);
...
LRESULT WindowsWindowFrame::OnMessageHandled(HWND wndHandle, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg)
    {
    case WM_CREATE:
    ...
    case WM_MOVE:
        {
            this->OnMove(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)));
        }
        return 0;

    case WM_SIZE:
        {
            this->OnResize(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)));
        }
        return 0;
    ...
    case WM_LBUTTONDOWN:
        {
            this->OnMouseDown(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)), MouseType::Left);
        }
        return 0;
    ...
    case WM_LBUTTONDBLCLK:
        {
            this->OnMouseDoubleClick(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)), MouseType::Left);
            return 0;
        }
        break;
    ...
    case WM_RBUTTONDBLCLK:
        {
            this->OnMouseDoubleClick(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)), MouseType::Right);
            return 0;
        }
        break;
    ...
    case WM_MBUTTONDBLCLK:
        {
            this->OnMouseDoubleClick(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)), MouseType::Middle);
            return 0;
        }
        break;
    ...
    case WM_MOUSEMOVE:
        {
            this->OnMouseMove(static_cast<int32_t>(LOWORD(lParam)), static_cast<int32_t>(HIWORD(lParam)));
            return 0;
        }
        break;
