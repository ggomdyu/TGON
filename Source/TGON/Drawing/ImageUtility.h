...
TGON_API uint8_t* LoadImageData(const char* filePath, int32_t* width, int32_t* height, int32_t* channels);

TGON_API uint8_t* LoadImageData(const uint8_t* srcData, int32_t srcDataBytes, int32_t* width, int32_t* height, int32_t* channels);
