...
//#endif
//
//	PrimitiveType m_drawPrimitiveType;
//};
//
//
//inline void OpenGLGraphicsDevice::DrawPrimitive( PrimitiveType primitiveType, uint32_t startVertex, uint32_t primitiveCount )
//{
