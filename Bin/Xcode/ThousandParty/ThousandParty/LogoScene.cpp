...
void LogoScene::InitPhase3()
{
    ...
    auto& glyphData = font->GetGlyphData(u'ホ', 300);
    auto& glyphData2 = font2->GetGlyphData(u'Q', 50);
    auto& glyphData3 = font3->GetGlyphData(u'Q', 50);
    auto& glyphData4 = font4->GetGlyphData(u'Q', 50);
